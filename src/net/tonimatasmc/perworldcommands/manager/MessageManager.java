...
public class MessageManager {
    public static void registerMessage() {
        ...
        Bukkit.getConsoleSender().sendMessage(PerWorldCommands.getPlugin().prefix + ChatColor.DARK_GREEN + " The plugin was activated (Version: " + PerWorldCommands.getPlugin().version + ")");
